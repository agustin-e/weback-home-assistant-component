...
class RobotController:
    ...
    CLEANING_STATES = {DIRECTION_CONTROL, ROBOT_PLANNING_RECT, RELOCATION, CLEAN_MODE_Z, CLEAN_MODE_AUTO,
                       CLEAN_MODE_EDGE, CLEAN_MODE_EDGE_DETECT, CLEAN_MODE_SPOT, CLEAN_MODE_SINGLE_ROOM, CLEAN_MODE_MOP,
                       CLEAN_MODE_SMART}
    ...
    def current_mode(self) -> str:
        try:
            ...
            _LOGGER.debug(
                "RobotController.current_mode - working status didnt exist -> setting to idle until I receive an update")
